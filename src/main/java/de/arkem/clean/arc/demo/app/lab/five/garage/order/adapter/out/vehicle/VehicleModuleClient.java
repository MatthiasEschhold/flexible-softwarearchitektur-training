package de.arkem.clean.arc.demo.app.lab.five.garage.order.adapter.out.vehicle;
...
import de.arkem.clean.arc.demo.app.lab.five.vehicle.usecase.in.FetchVehicleByLicensePlate;
...
public class VehicleModuleClient implements FetchVehicle {
    ...
    public Vehicle fetch(LicensePlate licensePlate) {
        return mapper.mapOriginVehicleToVehicle(fetchVehicleByLicensePlate.fetchByLicensePlate(
                new de.arkem.clean.arc.demo.app.lab.five.vehicle.domain.model.vehicle.LicensePlate(licensePlate.value())));
    }
}
