...
import de.arkem.clean.arc.demo.app.lab.four.vehicle.usecase.in.VehicleCommand;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.usecase.in.VehicleQuery;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.usecase.out.DetectInterpolTheftStatus;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.usecase.out.FetchHighRiskCountries;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.usecase.out.FetchVehicleMasterData;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.usecase.out.VehicleRepository;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.domain.model.theft.status.TheftStatus;
import de.arkem.clean.arc.demo.app.lab.four.vehicle.domain.model.theft.status.TheftStatusEnum;
...
public class VehicleCommandService implements VehicleCommand {
    ...
    public Vehicle createVehicle(Vin vin, VehicleMotionData vehicleMotionData) {
        ...
        Integer ratingResult = theftRiskRatingService.rateTheftRisk(vehicleMotionData.licensePlate(), fetchHighRiskCountries.fetch());
        if (ratingResult > 75) {
