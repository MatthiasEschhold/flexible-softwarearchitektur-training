package de.arkem.clean.arc.demo.app.parts.catalog.usecase.interactor;
...
import de.arkem.clean.arc.demo.app.parts.catalog.usecase.out.FetchPartCatalogViewQuery;
import de.arkem.clean.arc.demo.app.parts.catalog.usecase.out.FetchPartsCatalogView;
import de.arkem.clean.arc.demo.app.parts.catalog.usecase.out.LoadSpareParts;
...
public class LoadPartsCatalogViewInteractor implements LoadPartsCatalogView {
    ...
    private FetchPartCatalogViewQuery createFetchPartCatalogViewQuery(CategoryNumber mainCategory, CategoryNumber subCategory, Vehicle vehicle) {
        return new FetchPartCatalogViewQuery(mainCategory, subCategory, vehicle.getEquipmentCodes());
    }
}
