package de.arkem.clean.arc.demo.app.garage.order.usecase.interactor;

import de.arkem.clean.arc.demo.app.garage.order.usecase.in.CreateGarageOrderCommand;
import de.arkem.clean.arc.demo.app.garage.order.usecase.in.GarageOrderCommand;
import de.arkem.clean.arc.demo.app.garage.order.usecase.in.UpdateGarageOrderCommand;
...
import de.arkem.clean.arc.demo.app.garage.order.domain.service.GarageOrderDomainService;
...
class GarageOrderCommandInteractor implements GarageOrderCommand {
    ...
    private final GarageOrderDomainService domainService;

    public GarageOrderCommandInteractor(GarageOrderDbCommand dbCommand, GarageOrderDbQuery dbQuery, FetchVehicle fetchVehicle, AddOrderPositions addOrderPositions, GarageOrderDomainService domainService) {
