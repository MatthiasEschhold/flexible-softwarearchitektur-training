...
import de.arkem.clean.arc.demo.app.vehicle.usecase.in.GetVehicleByLicensePlate;

import java.util.Optional;

class VehicleModuleClient implements FetchVehicle {
    ...
    public Optional<Vehicle> fetch(LicensePlate licensePlate) {
        de.arkem.clean.arc.demo.app.vehicle.domain.model.vehicle.Vehicle vehicle = getVehicleByLicensePlate.get(new
                de.arkem.clean.arc.demo.app.vehicle.domain.model.vehicle.LicensePlate(licensePlate.getValue()));
        if (vehicle == null) {
