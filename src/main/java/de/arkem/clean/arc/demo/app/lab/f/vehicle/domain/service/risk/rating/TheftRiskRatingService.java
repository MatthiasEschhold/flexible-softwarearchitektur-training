...
import de.arkem.clean.arc.demo.app.lab.f.vehicle.domain.model.theft.status.CountryCode;
import de.arkem.clean.arc.demo.app.lab.f.vehicle.domain.model.theft.status.HighRiskVehicleModels;
