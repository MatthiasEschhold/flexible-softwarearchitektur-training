package de.arkem.clean.arc.demo.app.lab.five.garage.order.domain.service;

import de.arkem.clean.arc.demo.app.lab.five.garage.order.usecase.in.GarageOrderCommand;
