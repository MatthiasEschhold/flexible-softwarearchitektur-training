...
import de.arkem.clean.arc.demo.app.vehicle.usecase.interactor.UpdateMileageInteractor;
...
class UpdateMileageInteractorTest {
    ...
    private VehicleMasterData getVehicleMasterData() {
        return new VehicleMasterData(new CountryOfManufacture("DE"),
                Arrays.asList(new Equipment(new EquipmentCode("BA1234"),
                        new EquipmentLabel("Test Austattungsmerkmal"))));
    }
}